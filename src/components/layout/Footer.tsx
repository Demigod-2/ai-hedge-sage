      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <div className="col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-6">
              <div className="relative h-8 w-8 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-primary to-blue-600 rounded-lg" />
            ...
            <p className="text-sm text-muted-foreground mb-6 max-w-md">
              HedgeSage leverages AI to provide cutting-edge quantitative strategies for the Indian markets,
              helping investors make data-driven decisions with confidence.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {currentYear} HedgeSage. All rights reserved.
          </p>
          <div className="flex items-center mt-4 md:mt-0">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary transition-colors"
            >
              Status <ArrowUpRight className="h-3.5 w-3.5" />
            </a>
          </div>
        </div>
      </div>
